...
function App() {
  return (
    <div className='App'>
      ...
      {/* <Section
        title='Mission'
        subtitle='The Virginia Food Industry Association (VFIA) was formed to be the leading advocate for retail and wholesale food industries in the commonwealth of Virginia. With members representing more than 55,000 people statewide at more than 530 retail locations, the association provides resources and public affairs support to the food industry as its members work to serve their customers and nourish local communities across the commonwealth.'
        dark={false}
        id='section2'
      />
      <Section
